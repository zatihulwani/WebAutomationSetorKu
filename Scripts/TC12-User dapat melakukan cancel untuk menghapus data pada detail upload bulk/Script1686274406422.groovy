...
WebUI.click(findTestObject('Object Repository/Page_Detail Upload Bulk  Web Report/i_OTO_fa fa-trash'))

WebUI.click(findTestObject('Object Repository/Page_Detail Upload Bulk  Web Report/button_Cancel'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Page_Detail Upload Bulk  Web Report/button_OK (3)'))
