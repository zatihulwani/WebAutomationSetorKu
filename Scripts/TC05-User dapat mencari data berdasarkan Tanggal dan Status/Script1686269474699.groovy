...
WebUI.click(findTestObject('Object Repository/Page_Upload Bulk  Web Report/td_28'))

WebUI.click(findTestObject('Page_Upload Bulk  Web Report/input_SetorKu  Upload Bulk_end_date'))

WebUI.click(findTestObject('Page_Upload Bulk  Web Report/td_8'))

WebUI.selectOptionByValue(findTestObject('Page_Upload Bulk  Web Report/select_-- Status --                        _01c146'), 
    '1', true)
...
WebUI.click(findTestObject('Object Repository/Page_Upload Bulk  Web Report/a_2'))
