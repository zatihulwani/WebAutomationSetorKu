...
WebUI.click(findTestObject('Page_Detail Upload Bulk  Web Report/i_OTO_fa fa-trash - Copy'))

WebUI.click(findTestObject('Page_Detail Upload Bulk  Web Report/button_Delete'))

WebUI.click(findTestObject('Page_Detail Upload Bulk  Web Report/button_OK (4)'))
